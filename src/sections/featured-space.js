  ...
  feature: [
    {
      ...
      title: "SEC-approved",
      description:
        "We are a SEC-approved company, which means that we meet the highest standards of quality and safety.",
    },
    {
      id: 2,
      icon: users.src,
      title: "Experienced",
      description:
        "We have over 20 years of experience in the ship repairing industry.",
    },
    {
      id: 3,
      icon: wifi.src,
      ...
      description:
        "We are committed to providing our customers with the highest level of customer service.",
    },
  ],
  gallery: [
    {
        ...
        <Box sx={styles.contentWrapper}>
          <Box sx={styles.leftContent}>
            <SectionHeading
              sx={styles.heading}
              title="Why us?"
              description="There are many reasons why you should choose N9Power for your ship repairing needs. We are."
            />
