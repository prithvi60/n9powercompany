      ...
      <Container>
        <Flex sx={styles.contentWrapper}>
          ...
          <Box sx={styles.rightContent}>
            <SectionHeading
              sx={styles.heading}
              title="We have worldwide happy customers."
              description={`I was very impressed with the quality of work that N9Power did on my ship's engine. They were able to get my engine back up and running in no time. - Engineer Jane Doe`}
            />
